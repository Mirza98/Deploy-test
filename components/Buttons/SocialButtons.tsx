...
const SocialButtons: FC<SocialButtonsProps> = ({ color, className }) => {
  return (
    <div className={`buttons social-media-buttons ${className ? className : ''}`}>
      <a
        target="_blank"
        href="https://www.linkedin.com/company/aksa-d.o.o.-zenica"
      ...
      <a target="_blank" href="https://www.instagram.com/aksadoozenica/" rel="noopener noreferrer">
        <Button className="is-shadowless">
          <svg
            stroke="currentColor"
            fill="currentColor"
      ...
      <a target="_blank" href="https://www.facebook.com/AksadooZenica" rel="noopener noreferrer">
        <Button className="is-shadowless">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="36"
